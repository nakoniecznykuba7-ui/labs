      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-cyan-500/5 to-blue-500/5 backdrop-blur-xl rounded-2xl border border-cyan-500/20 p-6 hover:border-cyan-500/40 transition-all group">
            ...
            <ul className="space-y-2 mb-4">
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-cyan-400 mt-2 flex-shrink-0" aria-hidden="true"></div>
                <span className="text-gray-200">Pomagamy dobrać produkty i model sklepu</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-cyan-400 mt-2 flex-shrink-0" aria-hidden="true"></div>
                <span className="text-gray-200">Prosty lejek: ruch → oferta → pierwsze zamówienia</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-cyan-400 mt-2 flex-shrink-0" aria-hidden="true"></div>
                <span className="text-gray-200">Opcja: robisz sam albo zlecasz część zadań</span>
              </li>
            </ul>
          ...
          <div className="bg-gradient-to-br from-purple-500/5 to-pink-500/5 backdrop-blur-xl rounded-2xl border border-purple-500/20 p-8 hover:border-purple-500/40 transition-all group">
            ...
            <ul className="space-y-2 mb-4">
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-purple-400 mt-2 flex-shrink-0" aria-hidden="true"></div>
                <span className="text-gray-200">Pomagamy wybrać skill, który realnie ktoś kupi</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-purple-400 mt-2 flex-shrink-0" aria-hidden="true"></div>
                <span className="text-gray-200">Tworzymy razem pierwszą ofertę i przykładowe realizacje</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-purple-400 mt-2 flex-shrink-0" aria-hidden="true"></div>
                <span className="text-gray-200">Pokazujemy jak używać AI, żeby robić to szybciej i lepiej</span>
              </li>
            </ul>
          ...
          <div className="bg-gradient-to-br from-blue-500/5 to-indigo-500/5 backdrop-blur-xl rounded-2xl border border-blue-500/20 p-8 hover:border-blue-500/40 transition-all group">
            ...
            <ul className="space-y-2 mb-4">
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-2 flex-shrink-0" aria-hidden="true"></div>
                <span className="text-gray-200">Pomoc w ustawieniu oferty, cennika i pakietów</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-2 flex-shrink-0" aria-hidden="true"></div>
                <span className="text-gray-200">Prosty system pozyskiwania klientów (DM / ogłoszenia / polecenia)</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-2 flex-shrink-0" aria-hidden="true"></div>
                <span className="text-gray-200">Podstawowy system obsługi klienta, żeby nie tonąć w chaosie</span>
              </li>
            </ul>
