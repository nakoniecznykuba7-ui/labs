...
export default function Modal({ isOpen, onClose, children, backgroundClass }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div
        ref={modalRef}
        className={`relative w-full max-w-3xl max-h-[90vh] overflow-y-auto backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl ${backgroundClass || 'bg-gray-900/95'}`}
      >
